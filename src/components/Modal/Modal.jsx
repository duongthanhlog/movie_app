         ...
         {open && (
            ...
            >
               ...
               <nav className={clsx(styles.menu)}>
                  <h1>
                     <MdLocalMovies className={clsx(styles.menuHeadingIcon)} />
                     Discover
                  </h1>
                  <ul>
                     <Link onClick={closeModal} className={clsx(styles.menuItem)} to="movie">
                        Movie
                     </Link>
                     <Link onClick={closeModal} className={clsx(styles.menuItem)} to="tv">
                        Tv
                     </Link>
                  </ul>
               </nav>
